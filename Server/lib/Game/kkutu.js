...
function getRewards(mode, score, bonus, rank, all, ss, opts){
    ...
    if (opts.unknownword) rw.score = rw.score * 0.002;

	// all은 1~8
	// rank는 0~7
	switch(Const.GAME_TYPE[mode]){
		case "EKT":
			rw.score += score * 1400000000000000;
			break;
		case "ESH":
			rw.score += score * 500000000000000;
			break;
		case "KKT":
			rw.score += score * 1400000000000000;
			break;
		case "KSH":
			...
			break;
		case "CSQ":
			rw.score += score * 400000000000000;
			break;
		case 'KCW':
			rw.score += score * 1000000000000000;
			break;
		case 'KTY':
			rw.score += score * 300000000000000;
			break;
		case 'ETY':
			rw.score += score * 3700000000000000;
			break;
		case 'KAP':
			rw.score += score * 800000000000000;
			break;
		case 'HUN':
			rw.score += score * 500000000000000;
			break;
		case 'KDA':
			...
			break;
		case 'EDA':
			rw.score += score * 600000000000000;
			break;
		case 'KSS':
			rw.score += score * 500000000000000;
			break;
		case 'ESS':
			rw.score += score * 200000000000000;
			break;
		default:
			break;
	}
